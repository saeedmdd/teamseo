(function($) {
	...
	if ($('.main-slider-carousel').length) {
		$('.main-slider-carousel').owlCarousel({
			...
			smartSpeed: 500,
			autoplay: 6000,
			navText: [ '<span class="fa fa-angle-left" style="height:50px; width: 50px; border-radius: 50% !important;"></span>', '<span class="fa fa-angle-right" style="height:50px; width: 50px; border-radius: 50% !important;"></span>' ],
			responsive:{
				0:{
					items:1
				},
