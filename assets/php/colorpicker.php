<div class="color-palate rtl">
    <div class="color-palate-head">
        <h6>تم سایت مورد نظر را انتخاب کنید</h6>
    </div>
    <div class="various-color clearfix">
        <div class="colors-list">
            ...
            <span class="palate redd-color" data-theme-file="assets/css/color-themes/redd-color.html"></span>
        </div>
    </div>
